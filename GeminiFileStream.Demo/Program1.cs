...
namespace Global.GeminiFileStream.Demo;
using System;
...
public static class Program1 {
    public static void Main(string[] args) {
        ...
        //Break(GeminiFileStream.ShuffulStringArray(greeting), "ShuffulStringArray(greeting)");
        EchoWebLink(
        ...
        Debug(new { args });
        //var answer = GeminiFileStream.Add2(11, 22);
        //Debug(new { answer });
        var answer = 11 + 22;
        ExpectEquivalent(
            expected: 33,
        ...
        //Message("﴾↪️END OF GeminiFileStream↩️﴿");
    }
}